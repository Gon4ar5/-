...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 6,
		Rule(NS('S'), GRB_ERROR_SERIES, 5,   //  —труктура программы
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 2, 12,  // возможные конструкции в ф-и€х
		...
		Rule(NS('E'), GRB_ERROR_SERIES + 3, 14, // выражени€
			Rule::Chain(1, TS('i')),
			...
			Rule::Chain(4, TS('k'), TS('('), TS('W'), TS(')')),
			Rule::Chain(5, TS('k'), TS('('), TS('W'), TS(')'), NS('M')),
			Rule::Chain(4, TS('b'), TS('('), NS('W'), TS(')')),
			Rule::Chain(5, TS('b'), TS('('), NS('W'), TS(')'), NS('M'))
		),
		Rule(NS('M'), GRB_ERROR_SERIES + 5, 4, // знаки
